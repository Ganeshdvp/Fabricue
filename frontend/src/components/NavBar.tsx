  ...
  return (
    <>
     <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <img src='../../public/Fabricue.png' alt="logo"
            ...
            <button onClick={() => toggle ? setToggle(false) : setToggle(true)} aria-label="Menu" className="sm:hidden">
                {/* Menu Icon SVG */}
            ...
            {/* Mobile Menu */}
            <div className={`${toggle ? 'flex' : 'hidden'} absolute top-15 left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden`}>
