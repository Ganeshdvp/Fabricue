...
import { ViewProductShimmer } from "./errorAndLoading/ViewProductShimmer";
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                {data.stock === 0 ? (
                  ...
                  <span className="text-[10px] font-semibold bg-orange-50 text-orange-600 border border-orange-100 px-2 py-0.5 rounded-full">
              ...
              <p className="text-sm text-gray-400 mb-3">
                Men's casual shirt for daily wear and occasions
              </p>
              ...
              <div className="mb-5">
                ...
                <div className="inline-flex items-center bg-gray-50 border border-gray-200 rounded-xl overflow-hidden">
                  <button
                    onClick={decrease}
                    className="w-10 h-10 flex items-center justify-center text-amber-500 hover:bg-amber-50 transition text-lg font-medium cursor-pointer"
                  >
                    −
                  </button>
