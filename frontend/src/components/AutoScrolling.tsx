  ...
  return (
    <>
       <style>{`
            ...
            <div className="overflow-hidden w-full relative max-w-6xl mx-auto mt-26" onMouseEnter={() => setStopScroll(true)} onMouseLeave={() => setStopScroll(false)}>
                <h2 className="font-bold text-2xl text-center mb-8">Top Collections</h2>
